...
BLOG_AUTHOR = "COhPy Organizers"  # (translatable)
BLOG_TITLE = "COhPy"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://cohpy.gregback.net/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://cohpy.gregback.net/"
BLOG_EMAIL = "cohpy@gregback.net"
BLOG_DESCRIPTION = "The Central Ohio Python User's Group"  # (translatable)
